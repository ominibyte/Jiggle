...
public class CodeSmellFinder {
	...
	public static final File CODE_SMELLS_FOLDER = new File(GreenfootRipper.PROJECT_DIRECTORY, "CodeSmells/");
	...
	public CodeSmellFinder(JiggleActivityReporter reporter){
